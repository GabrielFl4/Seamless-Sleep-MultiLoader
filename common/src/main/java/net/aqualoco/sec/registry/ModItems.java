...
public final class ModItems {
    ...
    public static void register(BiConsumer<Item, Identifier> consumer) {
        Identifier id = Identifier.fromNamespaceAndPath(Constants.MOD_ID, "sleep_barrier");
    ...
    public static Item getSleepBarrierItem() {
        if (sleepBarrierItem == null) {
            throw new IllegalStateException("Sleep barrier item has not been registered yet.");
        }
