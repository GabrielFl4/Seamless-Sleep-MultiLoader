...
public final class ClientSleepAnimationState {
    ...
    public boolean isActiveForWorld(Identifier worldId) {
        return this.active
                && this.worldId != null
                && this.worldId.equals(worldId);
    }

    public boolean isBoundToWorld(Identifier worldId) {
    ...
    public void start(Identifier worldId, long startTimeOfDay, long endTimeOfDay, int durationTicks, long serverStartMillis) {
    ...
    public long getInterpolatedTime() {
        ...
        double eased = SleepAnimationState.integralEase(this.getProgress());
