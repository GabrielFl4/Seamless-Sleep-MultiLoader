...
public final class ForgeYaclConfigScreen {

    private ForgeYaclConfigScreen() {
    }
                                ...
                                .option(buildServerIntSlider(
                                        ...
                                        value -> {
                                            if (canEditServerConfig) {
                                                serverCfg.sleepWeatherClearChancePercent = value;
                                            }
                                        },
                                        canEditServerConfig
                                ))
    ...
    private static Option<Integer> buildServerIntSlider(Component name,
        ...
        Option.Builder<Integer> builder = Option.<Integer>createBuilder()
                ...
                .controller(opt -> IntegerSliderControllerBuilder.create(opt)
                        .range(min, max)
                        .step(step)
                        .formatValue(ForgeYaclConfigScreen::formatWeatherChanceValue));
        builder.available(available);
        return builder.build();
    }
