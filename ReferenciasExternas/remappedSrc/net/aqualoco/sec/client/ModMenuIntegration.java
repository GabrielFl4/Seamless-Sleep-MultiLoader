...
public class ModMenuIntegration implements ModMenuApi {
    ...
    private static class MissingYaclScreen extends Screen {
        ...
        public void render(net.minecraft.client.gui.GuiGraphics context, int mouseX, int mouseY, float delta) {
            ...
            context.drawCenteredString(this.font, Component.literal("YACL nao encontrado").withStyle(ChatFormatting.RED), x, y, 0xFFFFFF);
            context.drawCenteredString(this.font, Component.literal("Instale YetAnotherConfigLib v3 para editar a config."), x, y + 12, 0xFFFFFF);
