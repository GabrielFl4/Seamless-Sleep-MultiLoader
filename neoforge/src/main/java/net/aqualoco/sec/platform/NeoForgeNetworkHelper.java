...
// NeoForge 1.20.1 keeps the Forge networking packages while using NeoForged artifacts.
public class NeoForgeNetworkHelper implements INetworkHelper {
    ...
    public void sendToPlayers(ServerLevel world, SeamlessSleepPacket payload) {
        ...
        for (ServerPlayer player : world.players()) {
            ...
            Constants.warn("Ignoring unsupported packet type on NeoForge network helper: {}", payload.getClass().getName());
        }
    }
